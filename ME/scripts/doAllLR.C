...
void doAllLR()
{
  ...
  */
  ...
  TString meFDir = "/smurf/yygao/SmurfV3/datame/";
  TString outputDir = "../output/";
    
  // HWW 130
  // make output root files containing the LR for each process, given a certain higgs mass
  LR(smurfFDir, meFDir, "ww_ME.root", outputDir, maxevt, proc_HWW130, 80.0, TVar::INFO);
  LR(smurfFDir, meFDir, "hww130_ME.root", outputDir, maxevt, proc_HWW130, 80.0, TVar::INFO);
  LR(smurfFDir, meFDir, "ttbar_ME.root", outputDir, maxevt, proc_HWW130, 80.0, TVar::INFO);
  LR(smurfFDir, meFDir, "wjets_ME.root", outputDir, maxevt, proc_HWW130, 80.0, TVar::INFO);
  ...
  // HWW 160
  LR(smurfFDir, meFDir, "ww_ME.root", outputDir, maxevt, proc_HWW160, 100.0, TVar::INFO);
  LR(smurfFDir, meFDir, "hww160_ME.root", outputDir, maxevt, proc_HWW160, 100.0, TVar::INFO);
  LR(smurfFDir, meFDir, "ttbar_ME.root", outputDir, maxevt, proc_HWW160, 100.0, TVar::INFO);
  LR(smurfFDir, meFDir, "wjets_ME.root", outputDir, maxevt, proc_HWW160, 100.0, TVar::INFO);
  makeOverlay(TVar::HWW160, smurfFDir, outputDir, "_LR_hww160.root", 100.0, 30.9, 1.3+17.3, 11.05, 1.79+0.14);


  // HWW 200
  LR(smurfFDir, meFDir, "ww_ME.root", outputDir, maxevt, proc_HWW200, 130.0, TVar::INFO);
  LR(smurfFDir, meFDir, "hww200_ME.root", outputDir, maxevt, proc_HWW200, 130.0, TVar::INFO);
  LR(smurfFDir, meFDir, "ttbar_ME.root", outputDir, maxevt, proc_HWW200, 130.0, TVar::INFO);
  LR(smurfFDir, meFDir, "wjets_ME.root", outputDir, maxevt, proc_HWW200, 130.0, TVar::INFO);
