...
void zzskim()
{
  ...
  smurfproducer("/smurf/ksung/ntuples/", "wwup-mcatnlo.root", "/smurf/yygao/data/HZZ2011A/ZZ/allj/", "ZZ",3);
  smurfproducer("/smurf/ksung/ntuples/", "wwdown-mcatnlo.root", "/smurf/yygao/data/HZZ2011A/ZZ/allj/", "ZZ",3);
