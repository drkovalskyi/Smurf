...
assert(jetBin >= 0 && jetBin <= 1);
  Int_t mHiggs[9] = {115,120,130,140,150,160,170,180,190};
  Double_t WWBkgScaleFactorHiggsSelection[2][9] = { 
    { 1.18081,1.18081,1.15676,1.17591,1.15747,1.15747,1.15747,1.13758,1.16304},
    { 1.17671,1.17671,1.14186,1.20784,1.19952,1.19952,1.19952,1.13296,1.13531} };
  Int_t massIndex = -1;
  for (UInt_t m=0; m < 9 ; ++m) {
    if (mH == mHiggs[m]) massIndex = m;
  }
...
assert(jetBin >= 0 && jetBin <= 1);
  Int_t mHiggs[9] = {115,120,130,140,150,160,170,180,190};
  Double_t WWBkgScaleFactorKappaHiggsSelection[2][9] = { 
    { 1.07056,1.07056,1.07407,1.07568,1.07957,1.07957,1.07957,1.08439,1.08798},
    { 1.12386,1.12386,1.1307,1.12837,1.13364,1.13364,1.13364,1.14453,1.15184} };
  Int_t massIndex = -1;
  for (UInt_t m=0; m < 9 ; ++m) {
    if (mH == mHiggs[m]) massIndex = m;
  }
