 ...
 )
{
  ...
  if(fillInfoNote == true){
	...
	if(category == 1) sprintf(outputLimitsSpin,"output/histo_limits_%s_%dj_chan%d_mh%d_spin_lt_8TeV.txt",outTag.Data(),nJetsType,wwDecay,mH);
      ...
      newcardShape << Form("lumi_8TeV                        lnN 1.044 1.044 1.044 1.044 %5.3f %5.3f 1.044   -     -     -   1.044 1.044 1.044   - 1.044 1.044 1.044 1.044 1.044\n",lumiErr,lumiErr);			         
      if(useExpTemplates == true){
	...
	if(histo_qqWW2j->GetSumOfWeights() > 0)
      ...
      newcardSpin << Form("lumi_8TeV                        lnN 1.044 1.044 1.044 1.044 1.044 %5.3f %5.3f 1.044   -     -     -   1.044 1.044 1.044     - 1.044\n",lumiErr,lumiErr);			         
      if(useExpTemplates == true){
    ...
    newcardCut << Form("lumi_8TeV                  lnN 1.044 1.044 1.044 1.044 %5.3f %5.3f 1.044   -         -     -   1.044 1.044 1.044   - 1.044 1.044 1.044 1.044 1.044\n",lumiErr,lumiErr); 			      
