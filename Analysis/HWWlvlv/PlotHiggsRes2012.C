 ...
 )
{
  ...
  if(fillInfoNote == true){
	...
	if(histo_ggH_SM->GetSumOfWeights() > 0)
      ...
      newcardSpin << Form("lumi_8TeV                        lnN 1.022 1.022 %5.3f %5.3f 1.022   -     -     -   1.022 1.022 1.022     -\n",lumiErr,lumiErr);			         
      if(useExpTemplates == true){
