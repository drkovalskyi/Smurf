...
setenv BKG_TEST data/${TAG}_background42x_METVeto_ZVeto.root
setenv DAT_TEST data/${TAG}_data_2l_METVeto_ZVeto.root;

### Perform analysis
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",0,1,0\); --> mm
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",1,1,0\); --> me
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",2,1,0\); --> em
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",3,1,0\); --> ee
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",4,1,0\); --> ll
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",5,1,0\); --> sf
 #root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",6,1,0\); --> of

if ($MAKEINPUTS == "") then
  setenv INPUTDIR /data/smurf/ceballos/inputLimits/ana_v6_1500pb_LP_test;
  mkdir -p ${INPUTDIR}/${MH}
  if ($NJETS == 0) then
   root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",5,1\);
   root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",6,1\);
   ...
   root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",4,1\);
  ...
  root -l -q -b PlotHiggsRes_LP.C+\($NJETS,$MH,\"$TAG\",\"$SIG_TEST\",\"$BKG_TEST\"\,\"$DAT_TEST\",$MAKEINPUTS,1,0\);
