...
setenv DAT_TEST data/pseudo_data_4700ipb/${TAG}_pseudo_data_$NUMBER.root;
...
if ($MAKEINPUTS == "") then
  setenv INPUTDIR /data/smurf/ceballos/inputLimits/pseudo_data_4700ipb_sf/set_$NUMBER
  mkdir -p ${INPUTDIR}/${MH}
  if ($NJETS == 0) then
