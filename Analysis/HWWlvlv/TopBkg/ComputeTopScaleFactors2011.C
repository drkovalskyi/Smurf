 ...
 )
{
  ...
  for (int i=0; i<nBgd; ++i) {
    ...
    if(useDYMVA == false){
      if     (bgdEvent.njets_ == 0) passMET = passMET && (minmet > (37.+bgdEvent.nvtx_/2.0) || bgdEvent.type_ == SmurfTree::em || bgdEvent.type_ == SmurfTree::me);
      else if(bgdEvent.njets_ == 1) passMET = passMET && (minmet > (37.+bgdEvent.nvtx_/2.0) || bgdEvent.type_ == SmurfTree::em || bgdEvent.type_ == SmurfTree::me);
      else                          passMET = passMET && (minmet > (37.+bgdEvent.nvtx_/2.0) || bgdEvent.type_ == SmurfTree::em || bgdEvent.type_ == SmurfTree::me);
    } else {
  ...
  for (int i=0; i<nData; ++i) {
    ...
    bool passMET = minmet > 20.;
    if(useDYMVA == false){
      if     (dataEvent.njets_ == 0) passMET = passMET && (minmet > (37.+dataEvent.nvtx_/2.0) || dataEvent.type_ == SmurfTree::em || dataEvent.type_ == SmurfTree::me);
      else if(dataEvent.njets_ == 1) passMET = passMET && (minmet > (37.+dataEvent.nvtx_/2.0) || dataEvent.type_ == SmurfTree::em || dataEvent.type_ == SmurfTree::me);
      else                           passMET = passMET && (minmet > (37.+dataEvent.nvtx_/2.0) || dataEvent.type_ == SmurfTree::em || dataEvent.type_ == SmurfTree::me);
    } else {
