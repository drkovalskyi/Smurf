...
if(type == 0){ // 4th-generation gg->H enhancement factor
  ...
  else if(mass==111.000) return 10.0194;
  else if(mass==112.000) return 10.0086;
  else if(mass==113.000) return 9.99772;
  else if(mass==114.000) return 9.98688;
  else if(mass==115.000) return 9.97603;
  else if(mass==116.000) return 9.96519;
  else if(mass==117.000) return 9.95435;
  else if(mass==118.000) return 9.94351;
  else if(mass==119.000) return 9.93267;
  else if(mass==120.000) return 9.92183;
  else if(mass==121.000) return 9.90698;
  else if(mass==122.000) return 9.89214;
  else if(mass==123.000) return 9.87729;
  else if(mass==124.000) return 9.86245;
  else if(mass==125.000) return 9.8476 ;
  else if(mass==126.000) return 9.83275;
  else if(mass==127.000) return 9.81791;
  else if(mass==128.000) return 9.80306;
  else if(mass==129.000) return 9.78822;
  else if(mass==130.000) return 9.77337;
  else if(mass==131.000) return 9.76058;
  else if(mass==132.000) return 9.7478 ;
  else if(mass==133.000) return 9.73501;
  else if(mass==134.000) return 9.72223;
  else if(mass==135.000) return 9.70944;
  else if(mass==136.000) return 9.69665;
  else if(mass==137.000) return 9.68387;
  else if(mass==138.000) return 9.67108;
  else if(mass==139.000) return 9.65829;
  else if(mass==140.000) return 9.64551;
  else if(mass==141.000) return 9.61525;
  else if(mass==142.000) return 9.585  ;
  else if(mass==143.000) return 9.55474;
  else if(mass==144.000) return 9.52449;
  else if(mass==145.000) return 9.49423;
  else if(mass==146.000) return 9.48491;
  else if(mass==147.000) return 9.47559;
  else if(mass==148.000) return 9.46626;
  else if(mass==149.000) return 9.45694;
  ...
  else if(mass==174.000) return 9.41177;
  ...
  else if(mass==192.000) return 9.35003;
  else if(mass==194.000) return 9.33778;
  else if(mass==196.000) return 9.3171 ;
  else if(mass==198.000) return 9.288  ;
  else if(mass==200.000) return 9.25891;
  else if(mass==202.000) return 9.228  ;
  else if(mass==204.000) return 9.1971 ;
  else if(mass==206.000) return 9.16619;
  else if(mass==208.000) return 9.13529;
  else if(mass==210.000) return 9.10438;
  else if(mass==212.000) return 9.06522;
  else if(mass==214.000) return 9.02606;
  else if(mass==216.000) return 8.9869 ;
  else if(mass==218.000) return 8.94774;
  else if(mass==220.000) return 8.90858;
  else if(mass==222.000) return 8.87712;
  else if(mass==224.000) return 8.84566;
  else if(mass==226.000) return 8.8142 ;
  else if(mass==228.000) return 8.78274;
  else if(mass==230.000) return 8.75128;
  else if(mass==232.000) return 8.71563;
  else if(mass==234.000) return 8.67998;
  else if(mass==236.000) return 8.64433;
  else if(mass==238.000) return 8.60867;
  else if(mass==240.000) return 8.57302;
  else if(mass==242.000) return 8.53112;
  else if(mass==244.000) return 8.48923;
  else if(mass==246.000) return 8.44733;
  else if(mass==248.000) return 8.40543;
  else if(mass==250.000) return 8.36353;
  else if(mass==252.000) return 8.32494;
  else if(mass==254.000) return 8.28635;
  else if(mass==256.000) return 8.24775;
  else if(mass==258.000) return 8.20916;
  else if(mass==260.000) return 8.17057;
  else if(mass==262.000) return 8.12864;
  else if(mass==264.000) return 8.0867 ;
  else if(mass==266.000) return 8.04477;
  else if(mass==268.000) return 8.00283;
  else if(mass==270.000) return 7.96089;
  else if(mass==272.000) return 7.91174;
  else if(mass==274.000) return 7.86259;
  else if(mass==276.000) return 7.81344;
  else if(mass==278.000) return 7.76429;
  else if(mass==280.000) return 7.71513;
  else if(mass==282.000) return 7.6725 ;
  else if(mass==284.000) return 7.62987;
  else if(mass==286.000) return 7.58723;
  else if(mass==288.000) return 7.5446 ;
  else if(mass==290.000) return 7.50196;
  else if(mass==295.000) return 7.38434;
  else if(mass==300.000) return 7.26672;
  else if(mass==305.000) return 7.14327;
  else if(mass==310.000) return 7.01981;
  else if(mass==315.000) return 6.89219;
  else if(mass==320.000) return 6.76457;
  else if(mass==325.000) return 6.6037 ;
  ...
  else if(mass==440.000) return 4.50068;
  else if(mass==450.000) return 4.46942;
  else if(mass==460.000) return 4.43816;
  else if(mass==480.000) return 4.38596;
  else if(mass==500.000) return 4.35755;
  else if(mass==520.000) return 4.32779;
  else if(mass==540.000) return 4.29802;
  else if(mass==550.000) return 4.28314;
  else if(mass==560.000) return 4.28357;
  else if(mass==580.000) return 4.28442;
  ...
  else if(mass==111.000) return 0.150314;
  else if(mass==112.000) return 0.151251;
  else if(mass==113.000) return 0.152187;
  else if(mass==114.000) return 0.153123;
  else if(mass==115.000) return 0.15406 ;
  else if(mass==116.000) return 0.154996;
  else if(mass==117.000) return 0.155932;
  else if(mass==118.000) return 0.156868;
  else if(mass==119.000) return 0.157805;
  else if(mass==120.000) return 0.158741;
  else if(mass==121.000) return 0.161785;
  else if(mass==122.000) return 0.164829;
  else if(mass==123.000) return 0.167873;
  else if(mass==124.000) return 0.170917;
  else if(mass==125.000) return 0.17396 ;
  else if(mass==126.000) return 0.177004;
  else if(mass==127.000) return 0.180048;
  else if(mass==128.000) return 0.183092;
  else if(mass==129.000) return 0.186136;
  else if(mass==130.000) return 0.18918 ;
  else if(mass==131.000) return 0.195908;
  else if(mass==132.000) return 0.202636;
  else if(mass==133.000) return 0.209364;
  else if(mass==134.000) return 0.216092;
  else if(mass==135.000) return 0.22282 ;
  else if(mass==136.000) return 0.229549;
  else if(mass==137.000) return 0.236277;
  else if(mass==138.000) return 0.243005;
  else if(mass==139.000) return 0.249733;
  else if(mass==140.000) return 0.256461;
  else if(mass==141.000) return 0.266963;
  else if(mass==142.000) return 0.277465;
  else if(mass==143.000) return 0.287966;
  else if(mass==144.000) return 0.298468;
  else if(mass==145.000) return 0.30897 ;
  else if(mass==146.000) return 0.325973;
  else if(mass==147.000) return 0.342975;
  else if(mass==148.000) return 0.359978;
  else if(mass==149.000) return 0.37698 ;
  ...
  else if(mass==192.000) return 0.96645 ;
  else if(mass==194.000) return 0.965979;
  else if(mass==196.000) return 0.966387;
  else if(mass==198.000) return 0.967674;
  else if(mass==200.000) return 0.968961;
  else if(mass==202.000) return 0.97019 ;
  else if(mass==204.000) return 0.971418;
  else if(mass==206.000) return 0.972647;
  else if(mass==208.000) return 0.973875;
  else if(mass==210.000) return 0.975104;
  else if(mass==212.000) return 0.975601;
  else if(mass==214.000) return 0.976099;
  else if(mass==216.000) return 0.976596;
  else if(mass==218.000) return 0.977094;
  else if(mass==220.000) return 0.977591;
  else if(mass==222.000) return 0.9784	;
  else if(mass==224.000) return 0.97921 ;
  else if(mass==226.000) return 0.980019;
  else if(mass==228.000) return 0.980829;
  else if(mass==230.000) return 0.981638;
  else if(mass==232.000) return 0.981901;
  else if(mass==234.000) return 0.982165;
  else if(mass==236.000) return 0.982428;
  else if(mass==238.000) return 0.982692;
  else if(mass==240.000) return 0.982955;
  else if(mass==242.000) return 0.984082;
  else if(mass==244.000) return 0.985208;
  else if(mass==246.000) return 0.986335;
  else if(mass==248.000) return 0.987461;
  else if(mass==250.000) return 0.988588;
  else if(mass==252.000) return 0.988581;
  else if(mass==254.000) return 0.988575;
  else if(mass==256.000) return 0.988568;
  else if(mass==258.000) return 0.988562;
  else if(mass==260.000) return 0.988555;
  else if(mass==262.000) return 0.988262;
  else if(mass==264.000) return 0.987968;
  else if(mass==266.000) return 0.987675;
  else if(mass==268.000) return 0.987381;
  else if(mass==270.000) return 0.987088;
  else if(mass==272.000) return 0.987656;
  else if(mass==274.000) return 0.988224;
  else if(mass==276.000) return 0.988792;
  else if(mass==278.000) return 0.98936 ;
  else if(mass==280.000) return 0.989928;
  else if(mass==282.000) return 0.989922;
  else if(mass==284.000) return 0.989916;
  else if(mass==286.000) return 0.989911;
  else if(mass==288.000) return 0.989905;
  else if(mass==290.000) return 0.989899;
  else if(mass==295.000) return 0.989169;
  else if(mass==300.000) return 0.988439;
  else if(mass==305.000) return 0.986973;
  else if(mass==310.000) return 0.985507;
  else if(mass==315.000) return 0.985496;
  else if(mass==320.000) return 0.985486;
  else if(mass==325.000) return 0.985475;
  ...
  else if(mass==450.000) return 0.593819;
  else if(mass==460.000) return 0.590164;
  else if(mass==480.000) return 0.587912;
  else if(mass==500.000) return 0.589744;
  else if(mass==520.000) return 0.594574;
  else if(mass==540.000) return 0.599403;
  else if(mass==550.000) return 0.601818;
  else if(mass==560.000) return 0.605469;
  else if(mass==580.000) return 0.61277 ;
