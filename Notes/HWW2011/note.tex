...
\begin{titlepage}
  ...
  \begin{abstract}
    This note describes a Higgs boson search in the $\WW \to 2\ell2\nu$
    final state with 49~pb$^{-1}$ of $pp$ collision data at $\sqrt s =
    $ 7~$\TeV$. We search for Higgs boson candidate events in $ee$, $\mu\mu$ and $e\mu$
    channels with 0, 1 and 2 reconstructed jets in the final state. Signal and
    background yields are extrapolated to obtain a projection of our expected
sensitivity for an integrated luminosity of 1 $\ifb$.
  \end{abstract} 
