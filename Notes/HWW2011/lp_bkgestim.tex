This section describes the data-driven background Estimation for \lpintlumi. 
...
Here are the results from the method described in Section~\ref{sec:bkg_ww} applied to \lpintlumi.
