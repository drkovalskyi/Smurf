...
In Figure \ref{fig:IsoPerformance_Muon_LowPU}, we compare the performance of the 
...
\begin{figure}[!htbp]
\begin{center}
\subfigure[Muons in barrel, $p_{T}$ in $(10,20)$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_lowPU_lowPt_barrel.pdf}}
\subfigure[Muons in barrel, $p_{T}>20$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_lowPU_highPt_barrel.pdf}}
\subfigure[Muons in endcap, $p_{T}$ in $(10,20)$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_lowPU_lowPt_endcap.pdf}}
\subfigure[Muons in endcap, $p_{T}>20$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_lowPU_highPt_endcap.pdf}}
...
\begin{figure}[!htbp]
\begin{center}
\subfigure[Muons in barrel, $p_{T}$ in $(10,20)$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_highPU_lowPt_barrel.pdf}}
\subfigure[Muons in barrel, $p_{T}>20$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_highPU_highPt_barrel.pdf}}
\subfigure[Muons in endcap, $p_{T}$ in $(10,20)$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_highPU_lowPt_endcap.pdf}}
\subfigure[Muons in endcap, $p_{T}>20$ GeV]{\includegraphics[width=0.48\textwidth]{figures/muonIso_highPU_highPt_endcap.pdf}}
