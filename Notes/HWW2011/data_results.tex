...
Estimated values are in very good agreement with MC predictions and, with the current luminosity of $192~pb^{-1}$, 
...
Thus, we take the central values predicted by MC as WW estimate and assign an uncertainty of 30\% on it, corresponding to the current level of 
