...
\caption{Trailing lepton $p_T$ distribution after WW selection for 192 $\ipb$ of data in the 0-jet \subref{subfig:ww_ptmin_0j}, 
...
\caption{Leading lepton $p_T$ distribution after WW selection for 192 $\ipb$ of data in the 0-jet \subref{subfig:ww_ptmax_0j}, 
...
\caption{$min(\text{proj}_\text{trk-MET}, \text{proj}_\text{PFMET})$ distribution after WW selection for 192 $\ipb$ of data in the 0-jet \subref{subfig:ww_pmet_0j}, 
...
\caption{Transverse mass distribution after WW selection for 192 $\ipb$ of data in the 0-jet \subref{subfig:ww_mt_0j}, 
...
\caption{Invariant dilepton mass distribution after WW selection for 192 $\ipb$ of data in the 0-jet \subref{subfig:ww_dilmass_0j}, 
...
\caption{Dilepton $\Delta\phi$ distribution after WW selection for 192 $\ipb$ of data in the 0-jet \subref{subfig:ww_deltaphi_0j}, 
...
With 192 
$\ipb$ of data the median expected (observed) upper limit is about 0.8 (1.3) times the expectation 
