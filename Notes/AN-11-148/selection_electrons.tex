We select electrons using a cut-based approach similar to the electron 
...
jet induced background. The specific requirements to select good 
prompt electrons are the following:
...
We then require that there are no missing expected missing hits forming 
the electron track~\cite{ConversionNote},~\cite{NExpHits}. 
