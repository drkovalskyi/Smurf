...
\subfigure[]{
\centering
\label{subfig:ww_deltar_0j_LP}
\includegraphics[width=.32\textwidth]{lp_figures/histo_dr_ww0j_allhwwcuts.pdf}}
\subfigure[]{
\centering
\label{subfig:ww_deltar_1j_LP}
\includegraphics[width=.32\textwidth]{lp_figures/histo_dr_ww0j_allhwwcuts.pdf}}
\subfigure[]{
\centering
\label{subfig:ww_deltar_2j_LP}
\includegraphics[width=.32\textwidth]{lp_figures/histo_dr_ww0j_allhwwcuts.pdf}}\\
\caption{
