...
\fixme{Looks like we have some small bias. Need to get bigger statistics aTGC sample}
...
\begin{figure}[tp]
  ...
  \caption[1D fits to WW aTGC Monte Carlo] {\fixme{New to be
    updated}. Fits to $WW$ Monte Carlo samples with anomalous
