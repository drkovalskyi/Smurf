...
\includegraphics[width=0.3\linewidth]{figures/topbg_softbtag_denominator.pdf}
\includegraphics[width=0.3\linewidth]{figures/topbg_softbtag_numerator.pdf}
\includegraphics[width=0.3\linewidth]{figures/topbg_softbtag_control.pdf}
