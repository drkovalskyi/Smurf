...
The contribution to the uncertainty on the dilepton efficiency is about $1.5\%$. A detailed 
explanation is given in App.~\ref{app:lep_met_res}.
...
by an additional $10\%$. We find an uncertainty on the event selection efficiency of around 2\%. A detailed 
explanation is given in App.~\ref{app:lep_met_res}.
