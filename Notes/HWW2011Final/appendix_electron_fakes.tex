...
\begin{figure}[!htbp]
\begin{center}
\subfigure[$p_{T}$]{\includegraphics[width=0.45\textwidth]{figures/ElectronFakeRate_Pt.pdf}}
\subfigure[$\eta$]{\includegraphics[width=0.45\textwidth]{figures/ElectronFakeRate_Eta.pdf}}
