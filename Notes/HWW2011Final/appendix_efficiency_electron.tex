...
\begin{figure}[!htbp]
\begin{center}
\subfigure[$10$ \GeV\ $ < p_{T} \le 20$ \GeV]{\includegraphics[width=0.45\textwidth]{figures/ElectronEff_LowPt_VsEta.pdf}}
\subfigure[$p_{T} > 20$]{\includegraphics[width=0.45\textwidth]{figures/ElectronEff_HighPt_VsEta.pdf}}
\caption{Electron selection efficiency as a function of the $p_{T}$ of the electron.}
...
\begin{figure}[!htbp]
\begin{center}
\subfigure[Number of reconstructed primary vertices]{\includegraphics[width=0.45\textwidth]{figures/ElectronEff_LowPt_VsNVtx.pdf}}
\subfigure[Pileup energy density ($\rho$)]{\includegraphics[width=0.45\textwidth]{figures/ElectronEff_LowPt_VsRho.pdf}}
...
\begin{figure}[!htbp]
\begin{center}
\subfigure[Number of reconstructed primary vertices]{\includegraphics[width=0.45\textwidth]{figures/ElectronEff_HighPt_VsNVtx.pdf}}
\subfigure[Pileup energy density ($\rho$)]{\includegraphics[width=0.45\textwidth]{figures/ElectronEff_HighPt_VsRho.pdf}}
\caption{Electron selection efficiency as a function of the number of reconstructed primary vertices
