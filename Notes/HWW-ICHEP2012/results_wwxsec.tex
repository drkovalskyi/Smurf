...
\begin{equation*}
\sigma_{WW}  = 70.64 \pm 3.35~\mathrm{(stat.)} \pm 6.28~\mathrm{(syst.)} \pm 3.53~\mathrm{(lumi.)~pb} .
\end{equation*}
...
\includegraphics[width=.45\textwidth]{figures/pas_pt1_incl_wwxsec.pdf}}
\subfigure[Trailing lepton $p_{T}$]{\label{subfig:fig_inclplots_pt2}
\includegraphics[width=.45\textwidth]{figures/pas_pt2_incl_wwxsec.pdf}}
\subfigure[Dilepton system $p_{T}$]{\label{subfig:fig_inclplots_ptll}
\includegraphics[width=.45\textwidth]{figures/pas_ptll_incl_wwxsec.pdf}}
\subfigure[Dilepton system invariant mass]{\label{subfig:fig_inclplots_M}
\includegraphics[width=.45\textwidth]{figures/pas_mll_incl_wwxsec.pdf}}
