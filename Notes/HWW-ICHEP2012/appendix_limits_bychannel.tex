...
\includegraphics[width=.45\textwidth]{figures/limits_0jsf_cut-CLs-asymptotic_log.pdf}}
\centering
\subfigure[cut-based 0-Jet SF (zoom)]{
\centering
\label{subfig:0jsf_zoom_cut}
\includegraphics[width=.45\textwidth]{figures/limits_0jsf_cut-CLs-asymptotic_zoom_log.pdf}} \\
...
\includegraphics[width=.45\textwidth]{figures/limits_1jsf_cut-CLs-asymptotic_zoom_log.pdf}} \\
