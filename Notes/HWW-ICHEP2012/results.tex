...
\centering
\subfigure[Significance (shape-based)\fixme]{
\centering
\label{subfig:significance_8TeV_shape}
\includegraphics[width=.45\textwidth]{figures/significance_hWW8TeV.pdf} % FIXME 
}
\subfigure[best fit for $\sigma/\sigma_{SM}$ (shape-based)\fixme]{
\centering
\label{subfig:muHat_shape}
\includegraphics[width=.45\textwidth]{figures/hWW_mlf8TeV.pdf} % FIXME
}
...
\begin{figure}[!hbtp]
\centering
\subfigure[Significance\fixme]{
\centering
\label{subfig:significance_8TeV}
\includegraphics[width=.45\textwidth]{figures/significance_hWW8TeV.pdf}
}
\subfigure[best fit for $\sigma/\sigma_{SM}$\fixme]{
\centering
\label{subfig:muHat}
\includegraphics[width=.45\textwidth]{figures/hWW_mlf8TeV.pdf} % FIXME
}
