...
\input{appendix_mcFakes.tex}

\clearpage
\section{Fake muon studies using isolation sideband}
\label{app:appendix_fakeIso}
\input{appendix_fakeIso.tex}

\clearpage
\section{Virtual conversions studies with Z$\gamma$* control sample}
\label{app:appendix_zgstar}
\input{appendix_zgstar.tex}
