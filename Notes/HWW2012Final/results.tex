...
0.76 $\pm$ 0.13 (stat.) $\pm$ 16 (syst.) = 0.76 $\pm$ 0.21 (stat.+syst.).
...
\hline
   DF 0-jet bin shape-based 7 $\TeV$ & 0.60 $\pm$  0.52 \\
   DF 1-jet bin shape-based 7 $\TeV$ & 1.65 $\pm$  1.00 \\
   DF 0-jet bin shape-based 8 $\TeV$ & 0.69 $\pm$  0.31 \\
   DF 1-jet bin shape-based 8 $\TeV$ & 0.32 $\pm$  0.37 \\
     DF 0-jet bin cut-based 7 $\TeV$ & 0.83 $\pm$  0.49 \\
     DF 1-jet bin cut-based 7 $\TeV$ & 0.44 $\pm$  0.50 \\
     DF 0-jet bin cut-based 8 $\TeV$ & 0.29 $\pm$  0.68 \\
     DF 1-jet bin cut-based 8 $\TeV$ & 1.02 $\pm$  1.13 \\
     SF 0-jet bin cut-based 7 $\TeV$ & 0.18 $\pm$  1.04 \\
     SF 1-jet bin cut-based 7 $\TeV$ & 0.92 $\pm$  2.14 \\
     SF 0-jet bin cut-based 8 $\TeV$ & 1.08 $\pm$  0.75 \\
     SF 1-jet bin cut-based 8 $\TeV$ & 1.51 $\pm$  0.87 \\
\hline
         combined cut-based 7 $\TeV$ & 0.46 $\pm$ 0.57 \\
         combined cut-based 8 $\TeV$ & 0.79 $\pm$ 0.39 \\
       combined shape-based 7 $\TeV$ & 0.91 $\pm$ 0.44 \\
       combined shape-based 8 $\TeV$ & 0.71 $\pm$ 0.22 \\
\hline
       combined cut-based 7+8 $\TeV$ & 0.71 $\pm$ 0.37 \\
     combined shape-based 7+8 $\TeV$ & 0.76 $\pm$ 0.21 \\
\hline
\end{tabular}
