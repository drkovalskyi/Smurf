...
\includegraphics[width=.45\textwidth]{figures/mll_CR1.pdf}
}
\subfigure[\mt~in CR1]{
\centering
\label{subfig:cr1_mT}
\includegraphics[width=.45\textwidth]{figures/mT_CR1.pdf}
}\\
\subfigure[\mll~in CR2]{
\centering
\label{subfig:cr2_mll}
\includegraphics[width=.45\textwidth]{figures/mll_CR2.pdf}
}
\subfigure[\mt~in CR2]{
\centering
\label{subfig:cr2_mT}
\includegraphics[width=.45\textwidth]{figures/mT_CR2.pdf}
}\\
