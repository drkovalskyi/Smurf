...
process.p = cms.Path(process.muonFilters * process.leptonTreeMakerSequenceData2012 * process.pfParticleSelectionSequence * process.eleIsoSequence * process.leptonTreeMaker2012)
