...
process.p = cms.Path(process.electronFilters * process.leptonTreeMakerSequenceMC * process.pfParticleSelectionSequence * process.eleIsoSequence * process.leptonTreeMaker2012)
