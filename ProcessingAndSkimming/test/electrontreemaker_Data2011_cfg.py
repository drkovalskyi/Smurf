...
process.p = cms.Path(process.electronFilters * process.leptonTreeMakerSequenceData2011 * process.pfParticleSelectionSequence * process.eleIsoSequence * process.leptonTreeMaker2011)
