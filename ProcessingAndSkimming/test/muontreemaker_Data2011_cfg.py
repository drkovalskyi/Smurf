...
process.p = cms.Path(process.muonFilters * process.leptonTreeMakerSequenceData2011 * process.pfParticleSelectionSequence * process.eleIsoSequence * process.leptonTreeMaker2011)
