...
// main  
//
void getPostUncert(bool do_qqWW, int TOTALTOY,char* TESTNAME){ 
    ...
    float mTbins_CR1[9]     =   {120,140,160,180,200,220,240,260,280};
    float mTbins_CR2[7]     =   {60,70,80,90,100,110,120};
    TH1F* h1_mll_CR1_uncert = new TH1F("h1_mll_CR1_uncert", "h1_mll_CR1_uncert", 9, mllbins_CR1);
    TH1F* h1_mll_CR2_uncert = new TH1F("h1_mll_CR2_uncert", "h1_mll_CR2_uncert", 6, mllbins_CR2);
    TH1F* h1_mT_CR1_uncert  = new TH1F("h1_mT_CR1_uncert", "h1_mT_CR1_uncert", 8, mTbins_CR1);
    TH1F* h1_mT_CR2_uncert  = new TH1F("h1_mT_CR2_uncert", "h1_mT_CR2_uncert", 6, mTbins_CR2);
    ...
    if(1) { // debug 
        ...
        for(int i=0; i<9; i++) { 
            ...
            cout << i << " ::: " << mean_mll_CR1[i] << " +/- " << uncert_mll_CR1[i] << endl;  
        ...
        for(int i=0; i<6; i++) {
            ...
            cout << i << " ::: " << mean_mll_CR2[i] << " +/- " << uncert_mll_CR2[i] << endl;  
        ...
        for(int i=0; i<8; i++) {
            ...
            cout << i << " ::: " << mean_mT_CR1[i] << " +/- " << uncert_mT_CR1[i] << endl;  
        ...
        for(int i=0; i<6; i++) {
            ...
            cout << i << " ::: " << mean_mT_CR2[i] << " +/- " << uncert_mT_CR2[i] << endl;  
    ...
    c_fit->cd(1);
    for(int i=0; i<9; i++) h1_mll_CR1_uncert_bin[i]->Fit("gaus","goff");
    for(int i=0; i<6; i++) h1_mll_CR2_uncert_bin[i]->Fit("gaus","goff");
    for(int i=0; i<8; i++) h1_mT_CR1_uncert_bin[i]->Fit("gaus","goff");
    for(int i=0; i<6; i++) h1_mT_CR2_uncert_bin[i]->Fit("gaus","goff");
    delete c_fit; 
    ...
    if(1) { // debug 
        ...
        c_debug1->Print("/home/users/jaehyeok/public_html/misc/c_debug1.pdf");
        ...
        c_debug2->Print("/home/users/jaehyeok/public_html/misc/c_debug2.pdf");
        ...
        c_debug3->Print("/home/users/jaehyeok/public_html/misc/c_debug3.pdf");
        ...
        c_debug4->Print("/home/users/jaehyeok/public_html/misc/c_debug4.pdf");
    } 
