...
while True:
    ...
    m = re.match("n_exp_(\w+)_proc_(\w+)", norm_s.GetName());
    ...
    print " %-15s %7.3f" % (m.group(2), norm_s.getVal()) 
    norm_s_all = norm_s_all + norm_s.getVal()

print "-------------------------------"
print "Sum All      %7.3f" % norm_s_all 
print "-------------------------------"
